...
export const metadata: Metadata = {
  title: "產品列表",
  description: "杜邦美達坦克 8 款高壓飾面碳化實木芯地板完整列表。AC6超耐磨、200°C碳化實木芯、綠建材標章，每坪 NT$4,880 起。適合小孩寵物家庭與潮濕氣候。",
  openGraph: {
    title: "杜邦美達坦克 碳化實木芯地板 - 8 款花色完整列表",
    description: "2026 最新報價：2690-2、2690-4、2692-1S、2699-3、2699-5、2738-1、2755-6、2802-7。每坪 NT$4,880 起，立即加入購物車。",
  },
};
